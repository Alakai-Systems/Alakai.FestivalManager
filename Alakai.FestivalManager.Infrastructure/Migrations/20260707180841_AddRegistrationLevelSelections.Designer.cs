...
namespace Alakai.FestivalManager.Infrastructure.Migrations
{
    ...
    [Migration("20260707180841_AddRegistrationLevelSelections")]
    partial class AddRegistrationLevelSelections
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Alakai.FestivalManager.Domain.Entities.AccommodationBuildingPassType", b =>
                {
                    ...
                    b.HasOne("Alakai.FestivalManager.Domain.Entities.PassType", null)
                        .WithMany("AllowedBuildings")
                        .HasForeignKey("PassTypeId1");
