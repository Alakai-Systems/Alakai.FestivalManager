...
public class GetProductionAccommodationBuildingsByEditionIdHandler
{
    private readonly IProductionAccommodationBuildingRepository _buildingRepository;
    private readonly IEditionRepository _editionRepository;
    private readonly IMapper _mapper;

    public GetProductionAccommodationBuildingsByEditionIdHandler(IProductionAccommodationBuildingRepository buildingRepository, IEditionRepository editionRepository, IMapper mapper)
    {
    ...
    public async Task<IReadOnlyList<ProductionAccommodationBuildingDto>> HandleAsync(GetProductionAccommodationBuildingsByEditionIdQuery query, CancellationToken cancellationToken = default)
    {
