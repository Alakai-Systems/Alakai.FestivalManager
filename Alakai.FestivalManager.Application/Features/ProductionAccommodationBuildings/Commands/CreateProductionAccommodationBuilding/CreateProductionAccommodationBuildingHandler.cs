...
public class CreateProductionAccommodationBuildingHandler
{
    private readonly IProductionAccommodationBuildingRepository _buildingRepository;
    private readonly IEditionRepository _editionRepository;
    private readonly IMapper _mapper;

    public CreateProductionAccommodationBuildingHandler(IProductionAccommodationBuildingRepository buildingRepository, IEditionRepository editionRepository, IMapper mapper)
    {
    ...
    public async Task<ProductionAccommodationBuildingDto> HandleAsync(CreateProductionAccommodationBuildingCommand command, CancellationToken cancellationToken = default)
    {
