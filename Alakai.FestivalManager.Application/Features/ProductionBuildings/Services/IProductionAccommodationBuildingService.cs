...
{
    Task<ApiResponse<CreateProductionAccommodationBuildingResponse>> CreateAsync(CreateBuildingCommand command, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<UpdateProductionAccommodationBuildingResponse>> UpdateAsync(UpdateBuildingCommand command, CancellationToken cancellationToken = default);
